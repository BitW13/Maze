...
namespace Лабиринт
{
    ...
    {
        //класс, обрабатывающий события, принимающий данные, отображающий результаты
        DataGridView data;//таблица, на которой отображается лабиринт
        ...
        {
            /// <summary>
            /// Построчный вывод лабиринта в файл.
            /// </summary>
            for (int i = 0; i < 2; i++)
            {
                for (int j = 0; j < width; j++)
        ...
        {
            /// <summary>
            /// Вывод последней строки лабиринта.
            /// </summary>
        ...
        {
            ///<summary>
            ///Вывод последней строки лабиринта в файл.
            /// </summary>
            for (int i = 0; i < width; i++)
            {
        ...
        {            
            ///<summary>
            ///Генерирует весь лабиринт, обращаясь к методам класса GenerateMaze
            /// </summary>
        ...
        {
            ///<summary>
            ///Генерирует весь лабиринт в файл, обращаясь к методам класса GenerateMaze
            /// </summary>
